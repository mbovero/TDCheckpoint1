...
public class AreaOfEffect_RedFire extends AreaOfEffect {

    public AreaOfEffect_RedFire(State state, Control control, double x, double y, int spread) {
        super(state, control, x, y, spread);
        spriteFile = "red_fire.png";
        killRange = 33;
        duration = 10;
